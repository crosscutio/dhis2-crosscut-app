...
function Info(props) {
    ...
    // TO-DOL refactor this code to improve how we're handling text
    return <Modal>
            <TabBar fixed>
            ...
            {activeTab === 1 ? <div>
                ...
                <p>{i18n.t("Pending: your catchment areas are being created.")}</p>
                <p>{i18n.t("Ready: your catchment areas have been created and ready to be published to DHIS2.")}</p>
                <p>{i18n.t("Publishing: your catchment areas is in the process of being published.")}</p>
                <p>{i18n.t("Published: your catchment areas have been published to DHIS2.")}</p>
                <Divider/>
