      ...
      <Card>
        <DataTable>
          ...
          <TableBody loading>
            ...
            return <JobItem setAlert={setAlert} toggle={toggle} key={job.id} name={job.name} status={job.status} id={job.id} date={job.date} handleJobDetails={handleJobDetails} properties={job.properties}/>
          })}</TableBody>
        </DataTable>
      </Card>
    </div>
